...
(function ($) {
    ...
    /*window.LicensesOBJ = {
        api: {
            ...
            makeGetRequest: function (data, callback) {
                $.get(window.LicensesOBJ.api.endpoint, data, callback)
            },
            makePostRequest: function (data, callback) {
                $.post(window.LicensesOBJ.api.endpoint, data, callback)
            }
        },
        controllers: {
        ...
        helpers: {
            initTable: function(selector){
                ...
                window.table = table;
                if(selector) window.tables[selector] = table;
            },
            tableSort(bodySelector,dataTypeAPI){
                $(bodySelector).sortable({
                    items: "tr",
                    cursor: 'move',
                    opacity: 0.6,
                    update: function() {
                        ...
                        window.LicensesOBJ.api.makePostRequest({
                            type: dataTypeAPI,
                            ids: ids
                        })
                    }
