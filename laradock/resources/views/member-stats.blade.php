        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <select class="form-control mb-4 select-period">
                                ...
                                <option value="{{ Carbon\Carbon::today()->subDay()->format('Y-m-d') }}|{{ Carbon\Carbon::now()->subDay()->format('Y-m-d') }}">Ieri</option>
                    ...
                    @php
                        $members_today = auth()->user()->memberVideoCompleted;
                    @endphp
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="input-daterange input-group mb-4 d-none" id="datepicker7" data-date-format="yyyy-mm-dd"
                                ...
                                <input type="text" class="form-control search-range-date-chart-start" value="{{ Carbon\Carbon::now()->subDays(8)->format('Y-m-d') }}" name="start" placeholder="Data di inizio" />
...
@section('script')
    ...
    <script src="{{ URL::asset('/assets/js/pages/member-stats.js') }}"></script>
@endsection