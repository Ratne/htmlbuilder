                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            ...
                            <h4 class="mt-5">Statistiche - Coming soon</h4>
                            <p class="text-muted">Questa sezione &egrave; in via di sviluppo, torna a visitarla fra qualche tempo</p>

                            <div class="row justify-content-center mt-5">
                                <div class="col-md-8">
                                    <div data-countdown="2022/06/30" class="counter-number"></div>
                                </div> <!-- end col-->
                            </div> <!-- end row-->
                        </div>
                    </div>
