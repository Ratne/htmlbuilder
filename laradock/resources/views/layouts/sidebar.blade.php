<!-- ========== Left Sidebar Start ========== -->
<div class="vertical-menu {{ isset($sidebarClosed) ? 'top-0' : '' }}">
    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ route('headers.index') }}" class="waves-effect">
                        <i class="fa fa-header"></i>
                        <span key="t-dashboards">{{ __('Headers') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('footers.index') }}" class="waves-effect">
                        <i class="fa fa-chevron-down"></i>
                        <span key="t-dashboards">{{ __('Footers') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('pages.index') }}" class="waves-effect">
                        <i class="fa fa-file"></i>
                        <span key="t-dashboards">{{ __('Pages') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('modals.index') }}" class="waves-effect">
                        <i class="fa fa-window-maximize"></i>
                        <span key="t-dashboards">{{ __('Modals') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('templates.index') }}" class="waves-effect">
                        <i class="fa fa-file-text"></i>
                        <span key="t-dashboards">{{ __('Templates') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('categories.index') }}" class="waves-effect">
                        <i class="fa fa-object-group"></i>
                        <span key="t-dashboards">{{ __('Categories') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('settings.index') }}" class="waves-effect">
                        <i class="fa fa-gear"></i>
                        <span key="t-dashboards">{{ __('Settings') }}</span>
                    </a>
                </li>
                <!-- <li class="menu-title" key="t-menu">@lang('translation.Menu')</li>
