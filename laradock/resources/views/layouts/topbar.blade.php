...
<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex align-items-center">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="/" class="logo logo-light mt-3 py-4">
                    <span class="logo-sm">
                        <img src="{{ URL::asset('/assets/images/logo-small.png') }}" alt="" height="22" class="w-auto">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ URL::asset('/assets/images/logo-light.png') }}" alt="" height="" class="img-fluid w-auto">
                    </span>
                </a>
            </div>
    ...
    <div class="d-flex">
        ...
        @php
            $notifications = \App\Models\Notification::where('id_user',auth()->user()->id)->where('is_read',0)->orderBy('created_at','desc');
        @endphp
        <div class="dropdown {{ auth()->user()->user_type=='admin' ? 'd-none' : 'd-inline-block'}}">
            <button type="button" class="btn header-item noti-icon waves-effect" id="page-header-notifications-dropdown"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="bx bx-bell {{ $notifications->count()>0 ? 'bx-tada' : '' }}"></i>
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                ...
                <div class="p-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="/notifications" class="small" key="t-view-all"> @lang('translation.View_All')</a>
                        </div>
                    </div>
                </div>
                <div data-simplebar style="max-height: 230px;">
                    @foreach($notifications->limit(4)->get() as $notification)
                        <a href="" class="text-reset notification-item">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="mt-0 mb-1 d-none" key="t-your-order">@lang('translation.Your_order_is_placed')</h6>
                                    <div class="font-size-12 text-muted">
                                        <p class="mb-1" key="t-grammer">{{ $notification->notification }}</p>
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="rounded-circle header-profile-user d-inline-block" src="{{ isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('/assets/images/users/avatar-1.jpg') }}"
                    alt="Header Avatar">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <a class="dropdown-item d-block" href="#" data-bs-toggle="modal" data-bs-target=".change-password"><!-- <span class="badge bg-success float-end">11</span> --><i class="bx bx-wrench font-size-16 align-middle me-1"></i> <span key="t-settings">@lang('translation.Settings')</span></a>
                @if(auth()->user()->user_type=='team_manager')
                    <a class="dropdown-item" href="manager-preferences"><i class="bx bx-cog font-size-16 align-middle me-1"></i> <span key="t-profile">Preferenze</span></a>
                @elseif(auth()->user()->user_type=='team_member')
                <a class="dropdown-item" href="member-preferences"><i class="bx bx-cog font-size-16 align-middle me-1"></i> <span key="t-profile">Preferenze</span></a>
                @endif
                <a class="dropdown-item text-danger" href="javascript:void();" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="bx bx-power-off font-size-16 align-middle me-1 text-danger"></i> <span key="t-logout">@lang('translation.Logout')</span></a>
                <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                    @csrf
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Cambia Password</h5>
                ...
                <form method="POST" id="change-password">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="password" type="password"
                            ...
                            autocomplete="new_password" placeholder="Inserisci nuova password">
