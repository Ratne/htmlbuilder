...
var app_pages_assets = {
    js: [
        ...
        folder.src + "js/pages/pages/pages-create.js",
        folder.src + "js/pages/pages/pages-index.js",
        /*folder.src + "js/pages/admin-licenses.js",
        folder.src + "js/pages/admin-categories.js",
        folder.src + "js/pages/admin-subcategories.js",
        folder.src + "js/pages/admin-content.js",
        folder.src + "js/pages/manager-members.js",
        folder.src + "js/pages/content.js",
        folder.src + "js/pages/manager-preferences.js",
        folder.src + "js/pages/member-preferences.js",
        folder.src + "js/pages/manager-stats.js",
        folder.src + "js/pages/member-stats.js",*/
    ]
};

var app_components_assets = {
    js: [
        folder.src + "js/components/builder.js",
    ]
};

var app_helpers_assets = {
    js: [
        folder.src + "js/helpers/events.js",
    ]
};
...
lodash(app_components_assets).forEach(function(assets, type) {
    for (let i = 0; i < assets.length; ++i) {
        mix.js(assets[i], out + "components");
    };
});

lodash(app_helpers_assets).forEach(function(assets, type) {
    for (let i = 0; i < assets.length; ++i) {
        mix.js(assets[i], out + "helpers");
    };
});
